package com.xuejinwei.customeviewdemo.Clorks;
...
public class AnalogClock extends View {
    ...
    public AnalogClock(Context context, AttributeSet attrs, int defStyleAttr) {
        ...
        if (mDial == null) {
            mDial = context.getResources().getDrawable(R.drawable.clock_dial);
        }


        if (mHourHand == null) {
            mHourHand = context.getResources().getDrawable(R.drawable.clock_hand_hour);
        }
